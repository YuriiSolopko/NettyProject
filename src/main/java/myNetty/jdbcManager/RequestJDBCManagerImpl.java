 ...
 */
public class RequestJDBCManagerImpl implements RequestJDBCManager {
    ...
    private static volatile RequestJDBCManagerImpl instance = new RequestJDBCManagerImpl();

    private RequestJDBCManagerImpl() {
    ...
    public static RequestJDBCManagerImpl getInstance() {
        if (instance == null) {
            instance = new RequestJDBCManagerImpl();
        }
        return instance;
    }
